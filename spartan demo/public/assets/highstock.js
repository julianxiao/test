...
(function() {
    ...
    var r, B = document,
        ...
        Zb = /^[0-9]+$/,
        $b = "stroke-width",
        ib, La, ub, vb, wb, Ua, jb, kb, Nb, Ob, xb, Pb, Qb, C = {},
                ...
                q(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            m++;
                            if (l)
                                for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = e.length > 1 && j.whiteSpace !== "nowrap", q, r, D = a._clipHeight, t = [], s = p(), w = 1; n && (e.length || t.length);) delete a.bBox, q = a.getBBox(), r = q.width, !ca && c.forExport && (r = c.measureSpanWidth(u.firstChild.data, a.styles)), q = r > l, !q || e.length === 1 ? (e = t, t = [], e.length && (w++,
    ...
    L.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ja(h, this);
                ...
                for (; f-- && g === r;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ia(b / c, -1) + e[f]);
        ...
        getOffset: function() {
            var a = this,
                ...
                z, A, B, D, U = h === 2 ? c.fontMetrics(p.style.fontSize).b : 0;
        ...
        render: function() {
            ...
            if (G) b = a.getLinePath(G), a.axisLine ? a.axisLine.animate({
                d: b
    ...
    Xa.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                ...
                i = c.length;
                for (k = 0; k < i; k++)
                    if (c[k].visible && c[k].options.enableMouseTracking !== !1 && !c[k].noSharedTooltip && c[k].singularTooltips !== !0 && c[k].tooltipPoints.length && (e = c[k].tooltipPoints[l]) && e.series) e._dist = M(l - e.clientX),
    ...
    pb.prototype = {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker)
                    for (k in i.stroke = h, g = a.convertAttribs(g), g) d = g[k], d !== r && (i[k] = d);
                f.attr(i)
            }
        },
    ...
    K.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) q(a, function(a, b) {
                ...
                if (p && h > p) {
                    ...
                    if (la(j)) {
                        ...
                        if (G)
                            for (c = 0; c < h; c++) i = a[c], u[c] = i[0], s[c] = i.slice(1, G + 1);
                        else
                            for (c =
        ...
        generatePoints: function() {
            ...
            if (b && (g !== (c = b.length) || k))
                for (m = 0; m < c; m++)
                    if (m === h && !k && (m += g), b[m]) b[m].destroyElements(), b[m].plotX = r;
            this.data = b;
            this.points = l
        },
    ...
    Aa = ga(K, {
        ...
        drawPoints: function() {
            ...
            q(a.points, function(i) {
                var k = i.plotY,
                    j = i.graphic;
                if (k !== r && !isNaN(k) && i.y !== null) f = i.shapeArgs, h = t(a.borderWidth) ? {
    ...
    K.prototype.drawDataLabels = function() {
        var a = this,
            ...
            e = a.points,
            f, g, h, i;
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup", "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && o(d.defer, !0) && (i.attr({
            opacity: 0
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    if (l >
                        ...
                        for (D = 0; D < E; D++) {
                            ...
                            if (F < D && b[D] !== null) F = D;
                                ...
                                for (G < E - D + F && b[D] !== null && (F = G - E + D); b[F] === null;) F++;
                            H.push({
                                i: F,
                                y: b[F]
                            });
                ...
                if (Ba(U) === 0 || this.verifyDataLabelOverflow(U)) this.placeDataLabels(), u && g && q(this.points, function(b) {
                    i =
                        b.connector;
                    x = b.labelPos;
                    if ((r = b.dataLabel) && r._pos) A = r._attr.visibility, y = r.connX, z = r.connY, k = j ? ["M", y + (x[6] === "left" ? 5 : -5), z, "C", y, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", y + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({
                        d: k
    ...
    ba.groupData = function(a, b, c, d) {
        ...
        for (; o <= i; o++) {
            for (; c[1] !== r && a[o] >= c[1] || o === i;)
                if (k = c.shift(), j = d.apply(0, m), j !== r && (g.push(k), h.push(j)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], o === i) break;
            if (o === i) break;
            if (n) {
                k = this.cropStart + o;
    ...
    yb.prototype = {
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                ...
                if (t > h && t < h + g + k)
                    ...
                    if (f !== e) a.fixedWidth = r, e = c.toFixedRange(f, f + r, null, v), d.setExtremes(e.min, e.max, !0, !1, {
                        trigger: "navigator"
                    })
                }
            };
        ...
        addBaseSeries: function() {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1) A(a, "updatedData", this.updatedDataHandler), a.userOptions.events = v(a.userOptions.event, {
