...
module.exports = function(client, accountSid) {
    ...
    function Domains(sid) {
        ...
        generate.restFunctions(resourceApi, client, ['GET', 'POST', 'DELETE', {
                update: 'POST'
            }],
            baseResourceUrl + '/' + sid
        );
        ...
        resourceApi.ipAccessControlListMappings = ListInstanceResource(client, accountSid,
            'SIP/Domains/' + sid + '/IpAccessControlListMappings', ['GET', 'DELETE'], ['GET', 'POST', {
                create: 'POST'
            }, {
                list: 'GET'
            }]
        ...
        resourceApi.credentialListMappings = ListInstanceResource(client, accountSid,
            'SIP/Domains/' + sid + '/CredentialListMappings', ['GET', 'DELETE'], ['GET', 'POST', {
                create: 'POST'
            }, {
                list: 'GET'
            }]
    ...
    generate.restFunctions(Domains, client, ['GET', 'POST', {
            create: 'POST'
        }, {
            list: 'GET'
        }],
