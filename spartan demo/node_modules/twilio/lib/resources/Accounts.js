...
module.exports = function(client) {
    ...
    function mixinResources(obj, sid) {
        ...
        var subresources = {
            ...
            outgoingCallerIds: ListInstanceResource(client, sid, 'OutgoingCallerIds', ['GET', 'POST', 'PUT', 'DELETE', {
                update: 'PUT'
            }], ['GET', 'POST', {
                create: 'POST'
            }]),
            ...
            sms: {
                ...
                shortCodes: ListInstanceResource(client, sid, 'SMS/ShortCodes', ['GET', 'POST', {
                    update: 'POST'
                }], ['GET'])
            },
            applications: ListInstanceResource(client, sid, 'Applications', ['GET', 'POST', 'DELETE', {
                update: 'POST'
            }], ['GET', 'POST', {
                create: 'POST'
            }]),
            connectApps: ListInstanceResource(client, sid, 'ConnectApps', ['GET', 'POST', {
                update: 'POST'
            }], ['GET']),
            ...
            tokens: ListInstanceResource(client, sid, 'Tokens', [], ['POST', {
                create: 'POST'
            }]),
            transcriptions: ListInstanceResource(client, sid, 'Transcriptions', ['GET', 'DELETE'], ['GET']),
            notifications: ListInstanceResource(client, sid, 'Notifications', ['GET', 'DELETE'], ['GET']),
            usage: {
                records: require('./UsageRecords')(client, sid),
                triggers: ListInstanceResource(client, sid, 'Usage/Triggers', ['GET', 'POST', 'DELETE', {
                    update: 'POST'
                }], ['GET', 'POST', {
                    create: 'POST'
                }])
