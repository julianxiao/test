...
var tests = {
    ...
    testGetChunkBreak: {
        resp: server.createChunkResponse(
            [new Buffer([239]), new Buffer([163]), new Buffer([191]), new Buffer([206]), new Buffer([169]), new Buffer([226]), new Buffer([152]), new Buffer([131])]),
        expectBody: "Ω☃"
    },
    testGetJSON: {
    ...
    testPutJSON: {
        resp: server.createPostValidator(JSON.stringify({
            foo: 'bar'
        })),
        method: "PUT",
        json: {
...
s.listen(s.port, function() {
    ...
    for (i in tests) {
        (function() {
            ...
            test.ca = ca
            test.headers = {
                host: 'testing.request.mikealrogers.com'
            }
