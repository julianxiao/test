...
[
  ...
  var hot = new Handsontable(container, {
    ...
    columns: [
       {data: 0, type: 'numeric', format: '0,0.00[0000]'},
      {data: 1, type: 'numeric', format: '0,0.00[0000]'},
       {data: 2, type: 'numeric', format: '0,0.00[0000]'},
      {data: 3, type: 'numeric', format: '0,0.00[0000]'},
       {data: 4, type: 'numeric', format: '0,0.00[0000]'},
      {data: 5, type: 'numeric', format: '0,0.00[0000]'},
       {data: 6, type: 'numeric', format: '0,0.00[0000]'},
      {data: 7, type: 'numeric', format: '0,0.00[0000]'},
       {data: 8, type: 'numeric', format: '0,0.00[0000]'},
      {data: 9, type: 'numeric', format: '0,0.00[0000]'}
    ]
  });
var advancedData2 = 
  [
