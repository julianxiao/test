! function() {
    ...
    var c = 9007199254740992,
        ...
        j = function(a) {
            return this instanceof j ? (void 0 !== a && ("function" == typeof a ? this.random = a : this.seed = a), void("undefined" == typeof this.random && (this.mt = this.mersenne_twister(a), this.random = function() {
    ...
    j.prototype.bool = function(c) {
        return c = a(c, {
            likelihood: 50
        }), b(c.likelihood < 0 || c.likelihood > 100, "Chance: Likelihood accepts values from 0 to 100."), 100 * this.random() < c.likelihood
    }, j.prototype.character = function(c) {
        c = a(c);
        var d, h, i = "!@#$%^&*()[]";
        return b(c.alpha && c.symbols, "Chance: Cannot specify both alpha and symbols."), d = "lower" === c.casing ? f : "upper" === c.casing ? g : f + g, h = c.pool ? c.pool : c.alpha ? d : c.symbols ? i : d + e + i, h.charAt(this.natural({
            max: h.length - 1
        }))
        ...
        var g = c / f,
            h = -g;
        b(d.min && d.fixed && d.min < h, "Chance: Min specified is out of range with fixed. Min should be, at least, " + h), b(d.max && d.fixed && d.max > g, "Chance: Max specified is out of range with fixed. Max should be, at most, " + g), d = a(d, {
            min: h,
            max: g
        }), e = this.integer({
            min: d.min * f,
        ...
        return e = a(e, {
            min: d,
            max: c
        }), b(e.min > e.max, "Chance: Min cannot be greater than Max."), Math.floor(this.random() * (e.max - e.min + 1) + e.min)
        ...
        for (var e = [], f = 0; e.length < c;) {
            ...
            if (d.comparator(e, g) || (e.push(g), f = 0), ++f > 50 * c) throw new RangeError("Chance: num is likely too large for sample set")
        }
        return e
        ...
        return b = a(b, {
            year: (new Date).getFullYear() - this.age(b)
        }), this.date(b)
    };
    var k = {
    ...
    j.prototype.last = function() {
        ...
        return b = a(b, {
            gender: "all"
        }), b.full ? this.pick(this.name_prefixes(b.gender)).name : this.pick(this.name_prefixes(b.gender)).abbreviation
        ...
        var c = this.areacode(b).toString(),
            d = this.natural({
                min: 2,
                max: 9
            }).toString() + this.natural({
        ...
        }), b.max = "undefined" != typeof b.max ? b.max : b.min + 100, this.natural(b).toString()
        ...
        if (b.future) {
            do c = this.month({
                raw: !0
            }).numeric, d = parseInt(c, 10); while (d < (new Date).getMonth())
        } else c = this.month({
            raw: !0
        }).numeric;
        return c
    ...
    }, "undefined" != typeof exports && ("undefined" != typeof module && module.exports && (exports = module.exports = j), exports.Chance = j), "function" == typeof define && define.amd && define([], function() {
        return j
