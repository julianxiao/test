...
angular.module('faultApp', ['simplePagination'])
  .controller('FaultController', ['$scope', 'Pagination', 'filterFilter', function($scope, Pagination, filterFilter) {
    ...
    for (i = 0; i < 100; i++)
    {
      ...
      var deviceIDData = 'Component ' + chance.integer({min: 1, max: 4});
      ...
      var geolocationData = chance.coordinates();
      ...
      $scope.faultEvents.push({deviceID: deviceIDData, status: 'On', timestamp:formattedTime, temperature:temperatureData, currentreading:currentreadingData,
        ...
        humidity:humidityData, CO2:CO2Data, H2S:H2SData, water:waterData,humidity:humidityData, 
        methane: methaneData, type: "some type", geolocation: geolocationData});
    }
    ...
    if (params.device) {
      $scope.filterDevice = 'Component ' +  params.device;
    }
